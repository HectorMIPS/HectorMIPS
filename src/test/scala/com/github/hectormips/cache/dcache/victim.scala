...
//      // 默认四个周期传完
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h12345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h22345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h32345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h42345678".U)
//      buffer.clock.step(1)
//      buffer.io.waddr.poke("h12345".U) //tag = 1 ,index=0x23
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("ha2345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("hb2345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("hc2345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("hd2345678".U)
//      buffer.clock.step(1)
...
//      buffer.io.qdata.expect("ha2345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("hb2345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("hc2345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("hd2345678".U)
//      buffer.io.wvalid.poke(true.B)
...
//      buffer.clock.step(1)
//      buffer.io.qvalid.poke(false.B)
//      buffer.io.qdata.expect("h12345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("h22345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("h32345678".U)
//      buffer.clock.step(1)
//      buffer.io.qdata.expect("h42345678".U)
//
//    }
//  }
//
...
//      buffer.io.wdata.poke("h42345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h52345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h62345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h72345678".U)
//      buffer.clock.step(1)
//      buffer.io.wdata.poke("h82345678".U)
//      buffer.clock.step(1)
//      buffer.io.wvalid.poke(false.B)
//      buffer.clock.step(1)
//      buffer.io.qvalid.poke(true.B)
