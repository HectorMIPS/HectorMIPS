...
object ExceptionConst {
  ...
  val EXCEPTION_TLB_REFILL_FETCH  : UInt = 0x80.U
  val EXCEPTION_TLB_INVALID_FETCH : UInt = 0x100.U
  val EXCEPTION_TLB_MODIFIED_FETCH: UInt = 0x200.U
  val EXCEPTION_TLB_REFILL_DATA   : UInt = 0x400.U
  val EXCEPTION_TLB_INVALID_DATA  : UInt = 0x800.U
  val EXCEPTION_TLB_MODIFIED_DATA : UInt = 0x1000.U

  val EXCEPTION_PROGRAM_ADDR       : UInt = 0xBFC00380L.U
  val EXCEPTION_PROGRAM_ADDR_REFILL: UInt = 0xBFC00200L.U

  val EXCEPTION_FLAG_WIDTH: Int = 10
}
